  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-xl border-none text-[#1C1917] px-4 py-3 shadow-sm flex items-center justify-between">
      ...
      <button
        ...
        className="btn-fast bg-[#FAF7F2] border-none px-3.5 py-1.5 rounded-full text-xs font-brand font-extrabold text-[#1C1917] flex items-center gap-1.5 shadow-sm hover:bg-[#F5F0EB] transition-all"
      >
